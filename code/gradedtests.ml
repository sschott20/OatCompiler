...
let greedy_is_good_tests = [
 ...
 ("pset5programs/ifq2.oat", "", "5");
 ("pset5programs/length1.oat", "", "5");
...
let hw4_path_tests = [
 ...
 ("pset4programs/arrayargs4.oat", "", "0"); 
]
...
let hw4_medium_tests = [
  ...
  ("pset4programs/regalloctest.oat", "", "0");
  ("pset4programs/regalloctest2.oat", "", "137999986200000000")  
]
...
let struct_tests = [
("pset5programs/compile_assign_struct.oat", "", "16");
("pset5programs/compile_basic_struct.oat", "", "7");
("pset5programs/compile_global_struct.oat", "", "254");
("pset5programs/compile_nested_struct.oat", "", "10");
("pset5programs/compile_return_struct.oat", "", "0");
("pset5programs/compile_struct_array.oat", "", "15");
("pset5programs/compile_struct_fptr.oat", "", "7");
("pset5programs/compile_various_fields.oat", "", "hello253"); 
]

let fptr_tests = [
  ("pset5programs/compile_array_fptr.oat", "", "2");
  ("pset5programs/compile_func_argument.oat", "", "4");
  ("pset5programs/compile_global_fptr.oat", "", "7");
  ("pset5programs/compile_global_fptr_unordered.oat", "", "2");
  ("pset5programs/compile_scall_fptr.oat", "", "4");
  ("pset5programs/compile_var_fptr.oat", "", "1");
  ("pset5programs/compile_local_fptr.oat", "", "5");
  ("pset5programs/compile_function_shadow.oat", "", "12");
  ("pset5programs/compile_global_struct_fptr.oat", "", "20");
  ("pset5programs/compile_builtin_argument.oat", "", "abab0");    
]

let regalloc_challenge_tests = [
 ("pset4programs/arrayargs3.oat", "", "34");
 ("pset4programs/run41.oat", "", "3");
 ("pset4programs/run51.oat", "", "341");
 ("pset4programs/run52.oat", "", "15");
 ("pset4programs/run54.oat", "", "10");
 ("pset4programs/run55.oat", "", "6");    
 ("pset4programs/qsort.oat", "", "kpyf{shomfhkmopsy{255");
 ("pset4programs/count_sort.oat", "", "AFHZAAEYC\nAAACEFHYZ0");
]

let new_tests = [
  ("pset5programs/ifq1.oat", "", "4");
  ("pset5programs/length2.oat", "", "3");  
  ("pset5programs/initarr1.oat", "", "1");
  ("pset5programs/initarr2.oat", "", "2");
]
...
let manual_tests : suite = [
    ManualTest ("Student submitted test case", 5, [])
  ; ManualTest ("Performance Comparison", 5, [])
  ]
